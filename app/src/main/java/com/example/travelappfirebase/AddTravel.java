...
public class AddTravel extends AppCompatActivity {
    ...
    String Storage_Path = "travels_images/";
    String Database_Path = "travels";
    android.widget.Button bChoose, bAdd;
    android.widget.EditText edName, edRange,edTime ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edRange = (EditText) findViewById(R.id.edRange);
        img = (ImageView) findViewById(R.id.img);

        storageReference = FirebaseStorage.getInstance().getReference();
        mDatabase = FirebaseDatabase.getInstance().getReference(Constants.DATABASE_PATH_UPLOADS);

        progressDialog = new android.app.ProgressDialog(AddTravel.this);
    ...
    public void uploadFile() {
        ...
        if (filePath != null) {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            sRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri downloadPhotoUrl) {
                                    Travel travel = new Travel(edName.getText().toString().trim(),
                                            Integer.parseInt(edRange.getText().toString().trim()),
                                            downloadPhotoUrl.toString());

                                    //adding an upload to firebase database
                                    String uploadId = mDatabase.push().getKey();
                                    mDatabase.child(uploadId).setValue(travel);
                                }
                            });
            ...
            android.widget.Toast.makeText(AddTravel.this, "Please Select Image or Add Image Name", android.widget.Toast.LENGTH_LONG).show();
        }
    }
